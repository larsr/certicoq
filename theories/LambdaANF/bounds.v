  ...
  Section Inline_bound. 
    ...
    Proof.
      ...
      { eapply Nat.le_trans. eassumption. eapply Nat.le_trans.
        erewrite <- Nat.add_le_mono_r. erewrite <- Nat.add_le_mono_l. 
    ...
    Proof.
      ...
      eapply Nat.le_trans. erewrite <- Nat.add_le_mono_r. erewrite <- Nat.add_le_mono_l. eapply Nat.mul_le_mono_l. eassumption.
      lia.
    Qed.
