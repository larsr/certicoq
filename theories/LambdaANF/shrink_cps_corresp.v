          ...
          { (* function inlining *)   
            ...
            - assert (Hinl' := Hinl). eapply inline_letapp_rename with (sig := sig) in Hinl'.
              ...
              + (* size for IH *) 
                ...
                eapply Nat.le_succ_l. eapply Nat.le_succ_l.
                eapply Nat.le_lt_trans. erewrite <- Nat.add_le_mono_r. eapply term_size_inline_letapp. eassumption.
    ...
    - (* fun *)
      ...
      + assert (Hube0 := gsr_clos_preserves_clos _ _ _ H11 H12 H14). destructAll.
        ...
        2:{ intros. eapply IHn; eauto.
            ...
            assert (gt_trans_S : forall n m p : nat, S n > m -> m > p -> n > p).
            { unfold gt. intros n' m p ? ?. apply Nat.lt_le_trans with m; auto. apply Nat.succ_le_mono; auto.  }
