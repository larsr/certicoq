...
Section CONTRACT.
  ...
  Defined.
  Next Obligation.
    assert ((forall im, sub_inl_size sub' im <= funs_size (fl) + sub_inl_size sub im /\ funs_size fl' <= funs_size fl))%nat. eapply precontractfun_size. eauto.  unfold term_sub_inl_size. simpl. specialize (H im). apply Nat.lt_succ_r. destruct H.
  ...
  Next Obligation.
    ...
    eapply Nat.le_lt_trans. rewrite <- Nat.add_le_mono_r. eapply term_size_inline_letapp.
